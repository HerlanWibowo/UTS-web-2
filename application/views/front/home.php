<div id="slides" class="carousel slide carousel-cus" data-ride="carousel">
    ...
    <div class="carousel-inner">
        <div class="carousel-item active">
            <img src="<?php echo base_url().'public/front/img/ck.jpg';?>" alt="FriesBrgrImg">
            <div class="carousel-caption text-left">
                <h1 class="display-2">Hungry?!</h1>
                <h3>Try this Chicken Katsu Bento your stomach will be satisfied</h3>
            </div>
        </div>
        <div class="carousel-item">
            <img src="<?php echo base_url().'public/front/img/bt.jpg';?>" alt="Spaghetti">
            <div class="carousel-caption text-right">
                <h1 class="display-2">Hungry?!</h1>
                <h3>Try this Beef Teriyaki Bento your tongue will be grateful </h3>
            </div>
        </div>
        <div class="carousel-item">
            <img src="<?php echo base_url().'public/front/img/bentobox.jpg';?>" alt="corn">
            <div class="carousel-caption text-right">
                <h1 class="display-2">Hungry?!</h1>
                <h3>Grab yours meal now!</h3>
